      ...
      >
        ...
        <div>
          ...
          <ul class="list-disc pl-4 space-y-1">
            <li>
              庫存動態：
              系統下單不代表購買成功，若遇官網缺貨、限購或下單失敗，客服將主動聯繫並全額退款。<br />
              請務必留意LINE 訊息通知。
            </li>
            <li>
              特價變動：
            ...
            <li>
              物流時效：商品皆由日本空運回台。<br />
              正常現貨狀況約 7-14
              個工作天抵台，若遇海關查驗或物流突發狀況，最長需等候
              30個工作天，急單請斟酌下單。
            </li>
            <li>
              代購性質：本服務屬「客製化給付」，下單後即進入採購流程，不適用
              7天鑑賞期，亦不接受取消訂單、改單或併單。
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="list-disc pl-4 space-y-1">
            <li>
              金額準確性：請依結帳畫面之「總金額」進行匯款。<br />
              若因個人疏失導致匯錯或重複匯款，退款將扣除轉帳手續費。
            </li>
            <li>
              自動取消：採人工核對匯款，狀態更新約需 1-2 個工作天。<br />
              若完成匯款 24
              小時後狀態未變，請主動聯繫客服，避免訂單因逾期（3日）被系統自動取消。
            </li>
            <li>
              惡意棄單：惡意跑單、故意匯錯金額或干擾系統運作者，本站將永久列入黑名單並停止一切服務。
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="list-disc pl-4 space-y-1">
            ...
            <li>
              拆封錄影：為保護雙方權益，收貨拆封時請務必全程錄影。<br />
              若無錄影存證，商品缺漏或重大損壞之爭議恕不受理。
            </li>
            <li>
            ...
            <li>
              瑕疵定義：代購非製造商，輕微線頭、溢膠、顏色與螢幕顯色差異等不屬瑕疵範圍。<br />
              若有重大破損，請憑完整影片聯繫客服解決。
            </li>
            <li>
              合法合規：
            ...
            <li>
              系統運行：
              我們致力於提供最精確的自動化服務，但若因不可抗力之系統異常導致訂單錯誤，本站保有最終解釋權與取消訂單之權利。<br />
              我們承諾全力保障您的權益，重大問題請務必連繫客服處理。
            </li>
          </ul>
        </div>
